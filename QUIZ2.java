...
public class QUIZ2 {
	...
	private void initialize() {
		...
		lblNewLabel_1.setBounds(910, 44, 110, 106);
		...
		JLabel QUEST2 = new JLabel("Q2. All keywords in C are in ________");
		...
		Q2OPT1 = new JRadioButton("CamelCase letters");
		...
		Q2OPT2 = new JRadioButton("UpperCase letters");
		...
		Q2OPT3 = new JRadioButton("Any Combination");
		...
		Q2OPT4 = new JRadioButton("LowerCase letters");
		...
		JLabel QUEST3 = new JLabel("Q3. What is #include <stdio.h>?");
		...
		Q3OPT1 = new JRadioButton("Inclusion directive");
		...
		Q3OPT2 = new JRadioButton("File inclusion directive");
		...
		Q3OPT3 = new JRadioButton("Preprocessor directive");
		...
		Q3OPT4 = new JRadioButton("None of the above");
		...
		JLabel QUEST4 = new JLabel("Q4. Which of the following are C preprocessors?");
		...
		Q4OPT2 = new JRadioButton("#define");
		...
		Q4OPT4 = new JRadioButton("all of the above");
		...
		JLabel QUEST5 = new JLabel("Q5. Which of the following is not a valid variable name declaration?");
		QUEST5.setVisible(false);
		QUEST5.setFont(new Font("Trebuchet MS", Font.BOLD, 18));
		QUEST5.setBounds(40, 240, 625, 29);
		frame.getContentPane().add(QUEST5);
		
		Q5OPT1 = new JRadioButton("int _a3;");
		...
		Q5OPT2 = new JRadioButton("int 3_a;");
		...
		Q5OPT3 = new JRadioButton("int a_3;");
		...
		Q5OPT4 = new JRadioButton("int _3a;");
