...
public class QUIZ3 {
	...
	private void initialize() {
		...
		JLabel QUEST1 = new JLabel("Q1. Who invented C++?");
		...
		Q1OPT3 = new JRadioButton("Ken Thompson");
		...
		Q1OPT4 = new JRadioButton("Brian Kernighan");
		...
		JLabel QUEST2 = new JLabel("Q2. What is C++?");
		...
		Q2OPT1 = new JRadioButton("object oriented");
		...
		Q2OPT2 = new JRadioButton("procedural programming");
		...
		Q2OPT3 = new JRadioButton("Both A & B");
		...
		Q2OPT4 = new JRadioButton("functional programming");
		...
		JLabel QUEST3 = new JLabel("Q3. Which of the following is a correct identifier in C++");
		...
		Q3OPT1 = new JRadioButton("VAR_1234");
		...
		Q3OPT2 = new JRadioButton("$var_name");
		...
		Q3OPT3 = new JRadioButton("7VARNAME");
		...
		Q3OPT4 = new JRadioButton("7var_name");
		...
		JLabel QUEST4 = new JLabel("Q4. Which of the following approach is used by C++?");
		...
		Q4OPT1 = new JRadioButton("Left-right");
		...
		Q4OPT2 = new JRadioButton("Right-left");
		...
		Q4OPT3 = new JRadioButton("Bottom-up");
		...
		Q4OPT4 = new JRadioButton("Top-down");
		...
		JLabel QUEST5 = new JLabel("Q5. Which of the following type is provided by C++ but not C?");
		...
		Q5OPT1 = new JRadioButton("double");
